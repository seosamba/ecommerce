...
class Tools_Misc
{
    ...
    public static $_merchandisingConfigTabs = array(
        ...
        3 => array('tabId' => 'group-pricing-tab', 'tabName' => 'Customers/Leads groups', 'type' => 'dynamic', 'settingActionPath' => 'configCustomerGroups'),
        4 => array('tabId' => 'user-attributes-assignment-rules', 'tabName' => 'Automated group assignment', 'type' => 'internal'),
        5 => array('tabId' => 'throttle-transactions', 'tabName' => 'Throttle transactions', 'type' => 'internal'),
    );
