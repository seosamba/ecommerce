...
[];a.target.checked?this.orders.each(function(a){c=_.union(c,[a.id]);a.set({checked:!0})}):(this.orders.each(function(a){b=_.union(b,[a.id]);a.set({checked:!1})}),c=_.difference(c,b));this.orders.ordersChecked=c},toggleOrder:function(a){var b=$(a.target).val();a.target.checked?this.orders.ordersChecked=_.union(this.orders.ordersChecked,[b]):(a=_.filter(this.orders.ordersChecked,function(a){return a!==b}),this.orders.ordersChecked=a)},exportOrdersAction:function(){var a=this.orders.ordersChecked.join(","),
c=this.orders.server_api.filter();_.isUndefined(b.Export);$.ajax({url:$("#website_url").val()+"plugin/shopping/run/getOrderExportConfig/",type:"GET",dataType:"json"}).done(function(d){d=_.template(p,{ordersIds:a,filters:$.param(c),i18n:b,defaultConfig:d.responseText.defaultConfig,exportConfig:d.responseText.export_config});$(d).dialog({dialogClass:"seotoaster",width:"75%",height:"750",resizable:!1});return!1})},resetFilters:function(){this.$("form.filters > :input").val("")},render:function(){},renderOrder:function(a){a.set({useInvoice:$("#invoiceEnable").val()});
...
a.hasClass("sortDown")?(a.hasClass("sortUp")&&(b+=" DESC"),a.hasClass("sortDown")&&(b+=" ASC"),a.toggleClass("sortUp").toggleClass("sortDown")):(a.addClass("sortUp"),b+=" ASC"),this.orders.server_api.order=b,this.orders.pager())},changeStatus:function(a){var c=$(a.currentTarget),d=parseInt(c.closest("div").data("order-id")),e=_.isUndefined(b["Are you sure you want to change status for this order?"])?"Are you sure you want to change status for this order?":b["Are you sure you want to change status for this order?"],
f=c.data("status"),g=this.orders.get(d);if("refunded"===f){e=_.isUndefined(b["Are you sure you want to refund this payment?"])?"Are you sure you want to refund this payment?":b["Are you sure you want to refund this payment?"];a=_.isUndefined(b.Refund)?"Refund":b.Refund;var h={},t=_.template(r,{i18n:b,orderId:d,gateway:g.get("gateway"),total:g.get("total")});h[a]=function(){$(".ui-dialog").css("zIndex","101");smoke.confirm(e,function(a){a&&$.ajax({url:$("#website_url").val()+"plugin/shopping/run/refundPayment/orderId/",
...
$(".ui-dialog-titlebar-close").trigger("click"))}})},{ok:_.isUndefined(b.Yes)?"Yes":b.Yes,cancel:_.isUndefined(b.No)?"No":b.No})};$(t).dialog({dialogClass:"seotoaster",width:"35%",height:"450",buttons:h,resizable:!1,open:function(a,b){},close:function(a,b){$(this).dialog("destroy")}})}else smoke.confirm(e,function(a){a&&$.ajax({url:$("#website_url").val()+"plugin/shopping/run/order?id="+d,data:{status:f},type:"POST",dataType:"json",beforeSend:function(){c.closest("td").html('<img src="'+$("#website_url").val()+
'system/images/ajax-loader-small.gif" style="margin: 20px auto; display: block;">')},success:function(a){showMessage(_.isUndefined(b.Saved)?"Saved":b.Saved,a.hasOwnProperty("error")&&a.error);!a.error&&a.hasOwnProperty("responseText")&&g.set("status",a.responseText.status)}})},{ok:_.isUndefined(b.Yes)?"Yes":b.Yes,cancel:_.isUndefined(b.No)?"No":b.No})},changeTracking:function(a){var c=$(a.currentTarget),d=parseInt(c.closest("tr").find("td.order-id").text()),e=this.orders.get(d);$.ajax({url:$("#website_url").val()+
"plugin/shopping/run/fetchShippingUrlNames",type:"GET",dataType:"json"}).done(function(a){a=_.template(q,{data:a.responseText.data,defaultSelection:a.responseText.defaultSelection,orderId:d,i18n:b});$(a).dialog({width:600,dialogClass:"seotoaster",resizable:!1,open:function(a,f){$(".setTracking").on("click",function(){});$(".save-data").on("click",function(){var a=$("#marketing-services").val(),f=$("#shippingTrackingId").val(),a={trackingUrlId:a,shippingTrackingId:f,id:d};$.ajax({url:$("#website_url").val()+
"plugin/shopping/run/order",data:a,type:"POST",dataType:"json",beforeSend:function(){c.closest("td").html('<img src="'+$("#website_url").val()+'system/images/ajax-loader-small.gif" style="margin: 20px auto; display: block;">')},success:function(a){a.hasOwnProperty("error")&&!a.error&&showMessage(_.isUndefined(b.Saved)?"Saved":b.Saved);a.hasOwnProperty("responseText")&&e.set({status:a.responseText.status,shipping_tracking_id:a.responseText.shippingTrackingId})}})})},close:function(a,b){$(this).dialog("close").remove()}})})},
sendInvoice:function(a){a=$(a.currentTarget);var c=parseInt(a.closest("tr").find("td.order-id").text()),d=a.closest("td"),e=d.html();$.ajax({url:$("#website_url").val()+"plugin/invoicetopdf/run/sendInvoiceToUser/",data:{cartId:c,dwn:0},type:"POST",dataType:"json",beforeSend:function(){d.html('<img src="'+$("#website_url").val()+'system/images/ajax-loader-small.gif" style="margin: 20px auto; display: block;">')},success:function(a){a.hasOwnProperty("error")&&(a.error?showMessage(a.responseText,!1,
5E3):showMessage(_.isUndefined(b["Invoice has been sent"])?"Invoice has been sent":b["Invoice has been sent"]));d.html(e)}})},toggleRecurring:function(a){"recurring_id"===$(a.currentTarget).val()?$(".recurring-filters").removeClass("hidden"):$(".recurring-filters").addClass("hidden")}})});
