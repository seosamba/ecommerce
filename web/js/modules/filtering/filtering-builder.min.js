...
$(a.currentTarget);a={product_id:this.productId,attribute_id:b.data("aid"),tags:b.data("tags"),value:b.val()};$.ajax({url:$("#website_url").val()+"api/filtering/eav/",type:"PUT",data:JSON.stringify(a),success:function(a){b.val(_.unescape(a.value))}})},autocomplete:function(a,b){var c=$.ui.autocomplete.escapeRegex(a.term).toLowerCase(),d=_.chain(TFilter.Attributes.toJSON()).filter(function(a){return-1!==a.label.toLowerCase().search(c)}).map(function(a){return{attribute_id:a.id,name:a.name,label:a.label,
value:null}}).value();b(d)}});$(function(){TFilter.Attributes.fetch()})};
