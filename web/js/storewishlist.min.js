...
!1,3E3);var f=$(".product-wishlist-"+b).data("qty");$(".product-wishlist-"+b).text(parseInt(f)+1);$(".last-user-full-name-"+b).text(a.responseText.lastAddedUser);c.find("img").attr("src","plugins/shopping/web/images/already-wished.png")}else showMessage(a.responseText,!0,3E3)}})})});
